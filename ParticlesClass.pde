...
*/
				...
				//rect(0,0,4,28);
				/* Used to turn images on and off  see javaKeyControl.pde   Key x  toggle    */
				...
				//if( p.contains(v.x,v.y) )  /* if point of drawing image is inside poly */
					...
					*/
					...
					float rd =random(rd_min,rd_max);      /* setup in setup()  */
						...
						println("Particles.pde (183)..img_random_1 = " + getFileName(PImagePathList.get(r_1))+"  imageCount = " + imageCount +" x = "+v.x+"  y = "+v.y);
						imageCount++;
				...
				if(image_count%freq_image_count_image_2==0 &&image_count%freq_image_count_image_1!=0 &&first_image==true)  //using two images
				{
						...
						image(img_random_2,0,0,(int)i_width2,(int)i_height2);  /*  image loaded here */
		                    ...
		                    println("Particles.pde (209) .. img_random_2 = " + getFileName(PImagePathList.get(r_2))+"  imageCount = " + imageCount+" x = "+v.x+"  y = "+v.y);
							imageCount++;
							if(show_data) {
							...
							/*.................................... 3 image ..............................*/
						if(image_count%freq_image_count_image_3==0 &&image_count%freq_image_count_image_1!=0&& third_image == true ) { //using three images
						...
						/*  Insert Image 2 */
						//image(img_random_3,(v.x+500),(v.y+500),i_width3,i_height3);  /*  image loaded here */
						image(img_random_3,0,0,i_width3,i_height3);  /*  image loaded here */
		                    println("Particles.pde (218) .. img_random_3 = " + getFileName(PImagePathList.get(r_3)) +"  imageCount = " + imageCount+" x = "+v.x+"  y = "+v.y);
							imageCount++;
